...
public final class Configs {
  public static final class MAXSwerveModule {
    ...
    static {
      ...
      drivingConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(45);
      drivingConfig
          .encoder
  ...
  public static final class CoralSubsystem {
    ...
    static {
      ...
      armConfig.idleMode(IdleMode.kCoast).smartCurrentLimit(45).voltageCompensation(12);
      ...
      elevatorConfig.idleMode(IdleMode.kCoast).smartCurrentLimit(45).voltageCompensation(12);
  ...
  public static final class AlgaeSubsystem {
    ...
    static {
      ...
      armConfig.smartCurrentLimit(45);
      ...
      // Configure basic settings of the intake motor
      intakeConfig.inverted(true).idleMode(IdleMode.kBrake).smartCurrentLimit(45);
    }
  }
}
